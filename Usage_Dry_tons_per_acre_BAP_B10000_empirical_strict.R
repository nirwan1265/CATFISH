...
OUT_DIR <- file.path(MAGMA_DIR, paste0("CATFISH_permutation_B", B_PERM, "_", PERM_MODE, "_empirical", OUT_SUFFIX))
...
results_csv <- file.path(
  OUT_DIR,
  paste0(OUT_PREFIX, "_CATFISH_", OMNIBUS, "_", PERM_MODE, "_B", B_PERM, "_empirical", OUT_SUFFIX, ".csv")
)
results_rds <- file.path(
  OUT_DIR,
  paste0(OUT_PREFIX, "_CATFISH_", OMNIBUS, "_", PERM_MODE, "_B", B_PERM, "_empirical", OUT_SUFFIX, ".rds")
)
