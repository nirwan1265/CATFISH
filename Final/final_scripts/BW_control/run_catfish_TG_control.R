#!/usr/bin/env Rscript
# ==============================================================================
# CATFISH Pipeline — TG_control (Triglycerides Control)
...
MAGMA_BASE    <- "/Users/nirwantandukar/Documents/Research/results/CATFISH/MAGMA/TG_control"
OUT_BASE      <- "/Users/nirwantandukar/Documents/Research/results/CATFISH/DGRP/TG_control"
...
genes_list <- lapply(CHROMS, function(chr) {
  ...
  if (!file.exists(f)) { message("  Skipping missing chromosome: ", chr); return(NULL) }
...
## -----------------------------------------------------------------------------
## 3. Build gene-gene correlation pairs
## -----------------------------------------------------------------------------
