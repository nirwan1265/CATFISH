...
BASE_DIR   <- "/Users/nirwantandukar/Documents/Research/results/CATFISH/DGRP/Second"
CATFISH_SUBDIR <- "CATFISH_permutation_B1000000_mvn_GPD"
GWAS_FILE  <- "/Users/nirwantandukar/Documents/Research/results/DGRP/DGRP_chilipeppers/GWAS_BLUEs/Second.assoc.txt"
...
pick_completed_catfish_csv <- function(base_dir, subdir, trait) {
  ...
  if (!length(hit)) stop("No CATFISH CSV found. Run run_catfish_Second.R first.", call.=FALSE)
