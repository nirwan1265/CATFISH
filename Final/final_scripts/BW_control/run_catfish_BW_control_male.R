#!/usr/bin/env Rscript
# ==============================================================================
# CATFISH Pipeline — BW_control_male (Body Weight Control, Male)
# Note: only 3 chromosomes present (2L, 2R, 3L) — 3R and X skipped automatically
# ==============================================================================
...
CHROMS     <- c("2L", "2R", "3L", "3R", "X")   # missing ones skipped automatically

MAGMA_BASE <- "/Users/nirwantandukar/Documents/Research/results/CATFISH/MAGMA/BW_control_male"
OUT_BASE   <- "/Users/nirwantandukar/Documents/Research/results/CATFISH/DGRP/BW_control_male"
