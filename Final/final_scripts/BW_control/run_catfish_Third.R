#!/usr/bin/env Rscript
# CATFISH Pipeline — Third (Drosophila DGRP)
...
MAGMA_BASE    <- "/Users/nirwantandukar/Documents/Research/results/CATFISH/MAGMA/Third"
OUT_BASE      <- "/Users/nirwantandukar/Documents/Research/results/CATFISH/DGRP/Third"
