#!/usr/bin/env Rscript
# ==============================================================================
# CATFISH Pathway Analysis — Drosophila Female Starvation Stress
...
# Paths
MAGMA_DIR  <- "/Users/nirwantandukar/Documents/Research/results/DGRP/MAGMA/Fly_magma_genes_by_chr_female"
COR_FILE   <- "/Users/nirwantandukar/Documents/Research/results/MAGMA/MAGCAT/magma_multi_snp_wise_genes_by_chr_N_maize/magma_gene_cor_pairs_MLM_Fly_female.txt"
...
cat("=== CATFISH Fly Female Starvation ===\n")
...
# Standardise P column (9th column is P in multi snp-wise output)
if (!"P" %in% names(genes_all_raw)) {
  names(genes_all_raw)[9] <- "P"
}

# Keep best P per gene (in case of overlap across chromosomes)
