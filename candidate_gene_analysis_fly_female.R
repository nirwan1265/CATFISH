...
# Drosophila - Female Starvation Stress Phenotype
# ==============================================================================
#
...
cat("\n\n========================================\n")
cat("Integrating Evidence Across Layers (Fly Female)\n")
cat("========================================\n")
...
png("candidate_genes_upset_fly_female.png",
...
cat("UpSet plot saved to candidate_genes_upset_fly_female.png\n")
...
cat("\n\n========================================\n")
cat("TOP CANDIDATE GENES (Fly Female)\n")
cat("========================================\n\n")
...
write.csv(
  gene_evidence %>%
    ...
    head(200),
  "candidate_genes_top200_fly_female.csv",
  row.names = FALSE
)

cat("\nFull table saved to candidate_genes_top200_fly_female.csv\n")
...
density_plot <- ggplot(density_df, aes(x = -log10(magma_p), fill = Group)) +
  ...
  labs(
    title = "MAGMA P-value Distribution (Fly Female)",
...
ggsave("pathway_gene_enrichment_density_fly_female.png", density_plot,
...
scatter_plot <- ggplot(
  ...
  labs(
    title = "GWAS vs MAGMA Evidence (Fly Female)",
...
quartz()
print(scatter_plot)
ggsave("gwas_vs_magma_scatter_fly_female.png", scatter_plot,
       width = 8, height = 8, dpi = 300, bg = "white")
...
ggsave("candidate_genes_summary_fly_female.png", summary_bar,
       width = 8, height = 8, dpi = 300, bg = "white")
...
# cat("\n\n")
# cat(strrep("=", 70), "\n")
# cat("FINAL SUMMARY: Candidate Gene Analysis (Fly Female)\n")
# cat(strrep("=", 70), "\n\n")
...
# cat("\n========== DONE (Fly Female) ==========\n")
# cat("Output files:\n")
# cat("  - candidate_genes_top200_fly_female.csv\n")
# cat("  - candidate_genes_upset_fly_female.png\n")
