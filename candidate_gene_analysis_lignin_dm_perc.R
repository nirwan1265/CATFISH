...
BASE_DIR <- "/Users/nirwantandukar/Documents/Research/results/CATFISH/MAGMA/Lignin_DM_perc"
GWAS_DIR <- "/Users/nirwantandukar/Documents/Research/results/GWAS/MLM/BAP/Lignin_DM_perc"
GENE_LOC_FILE <- "/Users/nirwantandukar/Documents/Github/MAGCAT/inst/extdata/sorghum.genes.loc"

OUT_DIR <- file.path(BASE_DIR, "candidate_gene_scoring_B10000_GPD_strict_tau")
...
pick_completed_catfish_csv <- function(base_dir) {
  csvs <- c(
    file.path(base_dir, "CATFISH_permutation_B10000_mvn_GPD_strict_tau", "Lignin_DM_perc_CATFISH_ACAT_mvn_B10000_GPD_strict_tau.csv"),
    file.path(base_dir, "CATFISH_permutation_B10000_mvn_GPD", "Lignin_DM_perc_CATFISH_ACAT_mvn_B10000_GPD.csv"),
    file.path(base_dir, "CATFISH_permutation_B10000_mvn", "Lignin_DM_perc_CATFISH_ACAT_mvn_B10000.csv")
  )
...
pick_completed_gene_table <- function(base_dir) {
  tsvs <- c(
    file.path(base_dir, "CATFISH_permutation_B10000_mvn_GPD_strict_tau", "Lignin_DM_perc_combined_genes.tsv"),
    file.path(base_dir, "CATFISH_permutation_B10000_mvn_GPD", "Lignin_DM_perc_combined_genes.tsv"),
    file.path(base_dir, "CATFISH_permutation_B10000_mvn", "Lignin_DM_perc_combined_genes.tsv")
  )
...
all_file <- file.path(OUT_DIR, "candidate_genes_all_Lignin_DM_perc_B10000_GPD_strict_tau.csv")
top50_file <- file.path(OUT_DIR, "candidate_genes_top50_Lignin_DM_perc_B10000_GPD_strict_tau.csv")
top200_file <- file.path(OUT_DIR, "candidate_genes_top200_Lignin_DM_perc_B10000_GPD_strict_tau.csv")
