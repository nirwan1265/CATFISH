...
# Copy this file to config.sap_stem_volume.sh on HPC and edit the paths below.
...
# SAP genotype VCFs. Adjust this pattern to match the exact chromosome files on HPC.
# Available placeholders: @CHR@ = 01..10, @CHR_NUM@ = 1..10
