# ==============================================================================
# Compare OMNIBUS Test vs Individual Component Tests - FLY FEMALE
...
omni_results <- read.csv(
  paste0(
    ...
    "catfish_omnibus_results_Fly_female_B10000/omni_acat_mvn.csv"
  ),
...
venn_plot1 <- ggVennDiagram(
  ...
  labs(
    title    = "OMNIBUS vs Union of All Component Tests (Fly Female)",
...
ggsave(
  "venn_omnibus_vs_components_union_fly_female.png",
...
if (requireNamespace("patchwork", quietly = TRUE)) {
  ...
  combined_venn <- (venn_plots[[1]] + venn_plots[[2]] + venn_plots[[3]]) /
    ...
    plot_annotation(
      title = "OMNIBUS vs Individual Component Tests (Fly Female)",
      subtitle = paste0("Threshold: ", threshold_label)
    )
  quartz()
  print(combined_venn)
  ggsave(
    "venn_omnibus_vs_each_component_fly_female.png",
...
cat("\n\n========================================\n")
cat("OMNIBUS Pathways: Component Support Analysis (Fly Female)\n")
cat("========================================\n\n")
...
support_bar <- ggplot(
  ...
  labs(
    title = "Component Test Support for OMNIBUS Pathways (Fly Female)",
    subtitle = paste0(
...
quartz()
print(support_bar)
ggsave("omnibus_component_support_fly_female.png", support_bar,
...
write.csv(output_table, "omnibus_pathways_with_support_fly_female.csv",
          row.names = FALSE)
cat("\nTable saved to omnibus_pathways_with_support_fly_female.csv\n")
...
png("upset_omnibus_and_components_fly_female.png",
...
dev.off()
cat("\nUpSet plot saved to upset_omnibus_and_components_fly_female.png\n")
...
heatmap_plot <- ggplot(
  ...
  labs(
    title = "P-value Comparison: OMNIBUS vs Components (Fly Female)",
...
ggsave("heatmap_omnibus_vs_components_fly_female.png",
...
cat("SUMMARY: OMNIBUS as a Holistic Test (Fly Female)\n")
cat("=" |> rep(60) |> paste(collapse = ""), "\n\n")
...
cum_bar <- ggplot(cum_support, aes(x = factor(k), y = fraction)) +
  ...
  labs(
    title = "Omnibus: Union vs Intersection (Fly Female)",
    subtitle = paste0(
...
quartz()
print(cum_bar)
ggsave("cumulative_support_omnibus_fly_female.png", cum_bar,
       width = 8, height = 8, dpi = 300)
...
jacc_plot <- ggplot(jacc_long,
  ...
  labs(
    title = "Set Similarity: OMNIBUS vs Each Component (Fly Female)",
    subtitle = paste0(
...
quartz()
print(jacc_plot)
ggsave("jaccard_overlap_omnibus_vs_components_fly_female.png", jacc_plot,
       width = 8, height = 8, dpi = 300)
...
p_heat2 <- ggplot() +
  ...
  labs(
    title = "P-value Heatmap with Component Ranks (Fly Female)",
...
ggsave("heatmap_with_winner_strip_fly_female.png", p_heat2,
...
cat("\n========== DONE (Fly Female) ==========\n")
cat("Output files:\n")
cat("  - venn_omnibus_vs_components_union_fly_female.png\n")
cat("  - venn_omnibus_vs_each_component_fly_female.png\n")
cat("  - omnibus_component_support_fly_female.png\n")
cat("  - omnibus_pathways_with_support_fly_female.csv\n")
cat("  - upset_omnibus_and_components_fly_female.png\n")
cat("  - heatmap_omnibus_vs_components_fly_female.png\n")
cat("  - cumulative_support_omnibus_fly_female.png\n")
cat("  - jaccard_overlap_omnibus_vs_components_fly_female.png\n")
cat("  - heatmap_with_winner_strip_fly_female.png\n")
