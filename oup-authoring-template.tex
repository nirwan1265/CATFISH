...
\begin{figure*}[!t]
    \centering
    \includegraphics[width=\textwidth]{fig/supp/SuppFig1_block_a_archetype_recovery_by_m.png}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=\textwidth,height=0.7\textheight,keepaspectratio]{fig/supp/SuppFig4_Component_Tests.png}
