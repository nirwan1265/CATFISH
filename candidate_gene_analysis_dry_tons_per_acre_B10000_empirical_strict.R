...
OUT_DIR <- file.path(BASE_DIR, "candidate_gene_scoring_B10000_empirical_strict_tau")
...
pick_completed_catfish_csv <- function(base_dir) {
  csvs <- c(
    file.path(base_dir, "CATFISH_permutation_B10000_mvn_empirical_strict_tau", "Dry_tons_per_acre_CATFISH_ACAT_mvn_B10000_empirical_strict_tau.csv"),
...
pick_completed_gene_table <- function(base_dir) {
  tsvs <- c(
    file.path(base_dir, "CATFISH_permutation_B10000_mvn_empirical_strict_tau", "Dry_tons_per_acre_combined_genes.tsv"),
...
all_file <- file.path(OUT_DIR, "candidate_genes_all_Dry_tons_per_acre_B10000_empirical_strict_tau.csv")
top50_file <- file.path(OUT_DIR, "candidate_genes_top50_Dry_tons_per_acre_B10000_empirical_strict_tau.csv")
top200_file <- file.path(OUT_DIR, "candidate_genes_top200_Dry_tons_per_acre_B10000_empirical_strict_tau.csv")
